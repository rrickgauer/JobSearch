...
<section id="top-navbar">
  <div class="container-fluid">
    <nav class="navbar navbar-toggleable-sm navbar-expand-sm navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="nav navbar-nav">
          ...
          <li class="nav-item nav-link-hover" id="companies-navbar-link"><a class="nav-link" href="companies.php">Companies</a></li>
          <li class="nav-item nav-link-hover" id="questions-navbar-link"><a class="nav-link" href="questions.php">Questions</a></li>
